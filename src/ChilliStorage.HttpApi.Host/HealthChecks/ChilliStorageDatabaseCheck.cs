...
public class ChilliStorageDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public ChilliStorageDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
